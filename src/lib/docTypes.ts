...
export const DOC_TYPES: DocTypeDef[] = [
  ...
  // ── Education ──
  { key: "marksheet", folder: "marksheet", en: "Marksheet", hi: "अंकतालिका", keywords: ["marksheet", "mark sheet", "markssheet", "मार्कशीट", "अंकतालिका", "अंक सूची", "grade card", "statement of marks", "semester", "सेमेस्टर", "10th", "12th", "class 10", "class 12", "high school", "intermediate", "हाईस्कूल", "इंटर"] },
  ...
  { key: "admit_card", folder: "education", en: "Admit Card", hi: "प्रवेश पत्र", keywords: ["admit card", "admit", "hall ticket", "प्रवेश पत्र", "roll no", "रोल नं"] },
  // ── Land ──
